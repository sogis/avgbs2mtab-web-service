...
public class Avgbs2mtabMainTest {
    ...
    */
    ...
    private HashMap<String, String> generateHashMapOfExpectedStringValuesOfSO0200002407_4002_20150807() {
        ...
        expectedValuesString.put("A6", "Rundungs-");
        expectedValuesString.put("A7", "differenz");
    ...
    private HashMap<String, String> generateHashMapOfExpectedStringValuesOfSO0200002407_4001_20150806() {
        ...
        expectedValuesString.put("A12", "Rundungs-");
        expectedValuesString.put("A13", "differenz");
    ...
    private HashMap<String, String> generateHashMapOfExpectedStringValuesOfSO0200002407_4004_20150810() {
        ...
        expectedValuesString.put("A18", "Rundungs-");
        expectedValuesString.put("A19", "differenz");
    ...
    private HashMap<String, String> generateHashMapOfExpectedStringValuesOfSO0200002427_809_20170529() {
        ...
        expectedValuesString.put("A10", "Rundungs-");
        expectedValuesString.put("A11", "differenz");
    ...
    private HashMap<String, String> generateHashMapOfExpectedStringValuesOfDprFromArmin_as_double() {
        ...
        expectedValuesString.put("A8", "Rundungs-");
        expectedValuesString.put("A9", "differenz");
